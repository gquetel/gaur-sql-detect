...
class ProjectPaths:
    ...
    def set_output_subfolder(self, subfolder: str):
        self.output_subfolder = subfolder

    @property
    def cache_datadir_path(self) -> str:
        path = f"/data/gquetel/cache/{self.trace_type}/"
    ...
    @property
    def inference_filepath(self) -> str:
        path = f"{self.output_path}/inference_time/"
        Path(path).mkdir(exist_ok=True, parents=True)
        return path
